...
#define nrn_init _nrn_init__gpulse
#define _nrn_initial _nrn_initial__gpulse
#define nrn_cur _nrn_cur__gpulse
#define _nrn_current _nrn_current__gpulse
#define nrn_jacob _nrn_jacob__gpulse
#define nrn_state _nrn_state__gpulse
#define _net_receive _net_receive__gpulse 
